...
| `targetElementWidth` | Set target element width. | `offsetWidth` at a time of creating the card. |
| `targetElementHeight` | Set target element height. | `offsetWidth` at a time of creating the card. |
