...
| `targetElementWidth` | Set target element width. | Using `offsetWidth` at a time of creating the card. |
| `targetElementHeight` | Set target element height. | Using `offsetWidth` at a time of creating the card. |
